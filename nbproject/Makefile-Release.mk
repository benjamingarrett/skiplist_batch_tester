...
${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist.o: ../indexed_skiplist/indexed_skiplist.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist.o ../indexed_skiplist/indexed_skiplist.c

${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist_long_int.o: ../indexed_skiplist/indexed_skiplist_long_int.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/d6f51a9a
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d6f51a9a/indexed_skiplist_long_int.o ../indexed_skiplist/indexed_skiplist_long_int.c
...
${OBJECTDIR}/skiplist_batch_test.o: skiplist_batch_test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/skiplist_batch_test.o skiplist_batch_test.c
